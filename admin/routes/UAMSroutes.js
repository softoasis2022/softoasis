...
routes.get("/", (req, res) => {
    const pagePath = path.join(PAGES_DIR,"UAMS","html","main.html");
...
routes.get("/create", (req, res) => {
    const pagePath = path.join(PAGES_DIR,"UAMS","html","create.html");
...
routes.get("/read", (req, res) => {
    const pagePath = path.join(PAGES_DIR,"UAMS","html","read.html");
...
// routes.post ("/read", (req, res) => {  조회 디비 API 요청
//     const pagePath = path.join(PAGES_DIR,"UAMS","html","read.html");
